...
class Allocator:
    def __init__(self):
        ...
        self.start_time = time.time()  # Start time for performance measurement

    def get_free_list_range(self, size):
        """Return the range in which the given size fits."""
    ...
    def malloc(self, id, size):
        """Allocate memory of the given size and associate it with the given id."""
    ...
    def free(self, id):
        """Free the memory associated with the given id."""
    ...
    def print_stats(self):
        """Print the current memory usage statistics."""
